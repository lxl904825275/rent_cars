 ...
 * date   : 2019/3/29
 */
@WebServlet(name = "incomeServlet",urlPatterns = "/incomeServlet",initParams = {@WebInitParam(name = "pageCount",value = "10")})
public class incomeServlet extends HttpServlet {
    ...
    protected void queryOne(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/background/account/carIncome.jsp").forward(request,response);
    ...
    protected void query(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pageBean.setCount(orderListDao.getConut());

        List<OrderList> orderLists = orderListDao.queryPage(pageBean);
